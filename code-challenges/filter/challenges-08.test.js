...
const oddValues = (arr) => {
  // Solution code here...
  // let oddValues1 = arr.filter((val,index)=>{
  //   if (val%2 !== 0) return oddValues1;
  // })
...
const filterStringsWithVowels = (arr) => {
  ...
  return arr.filter(string => {
    const vowels = (string.includes('a') || string.includes('e') || string.includes('i') || string.includes('o') || string.includes('u'))
    return vowels;
  });
};
